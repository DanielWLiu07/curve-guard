...
import SocialSignInButtons from './ui/SocialSignInButtons.jsx';
import SignInForm from './ui/SignInForm.jsx';
import SignUpForm from './ui/SignUpForm.jsx';
import ConfirmForm from './ui/ConfirmForm.jsx';
...
export default function SignInSection({ showSignIn, onBackToHero, onAuthSuccess }) {
  ...
  const handleBackToHeroInternal = () => {
    resetForm();
    setIsSignUp(false);
    onBackToHero();
  };
  ...
  return (
    <div className={`absolute inset-0 z-10 flex items-center pt-24 transition-all duration-700 ease-in-out ${
      showSignIn ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'
    }`}>
      <div className="w-full max-w-2xl ml-16 p-8 relative z-10">
          ...
          {isConfirming ? (
            ...
            <>
              <div className="text-center mb-6">
                ...
                <p className="text-white/70 text-sm">Choose your preferred sign in method</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed text-gray-900 py-3 px-4 rounded-md transition-colors font-medium border border-gray-300"
                >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white py-3 px-4 rounded-md transition-colors font-medium"
                >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 bg-black hover:bg-gray-900 disabled:opacity-50 disabled:cursor-not-allowed text-white py-3 px-4 rounded-md transition-colors font-medium"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 bg-gray-900 hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed text-white py-3 px-4 rounded-md transition-colors font-medium"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center mt-8">
          <button
            onClick={handleBackToHeroInternal}
