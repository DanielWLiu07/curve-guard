...
const CreatorSection = () => {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 flex items-start lg:items-center justify-center overflow-y-auto lg:overflow-hidden overflow-x-hidden pt-24 lg:pt-0 pb-8 lg:pb-0">
      <div className="absolute inset-0 bg-gradient-to-br from-jade-9/20 via-jade-8/20 to-jade-7/20" />

      <div className="absolute inset-0 pointer-events-none" />

      <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-[#0a0f1a] via-[#0a0f1a]/80 to-transparent pointer-events-none z-20 lg:hidden"></div>

      <div className="relative z-10 max-w-6xl mx-auto text-center px-6">
        <h2 className="text-4xl md:text-7xl font-black mb-8 mt-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 max-w-5xl mx-auto">
          ...
          <div className="flex-shrink-0">
            <div
              ref={avatarRef}
              className="relative w-48 h-48 md:w-80 md:h-80 mx-auto"
            >
              <div className="relative w-full h-full rounded-full bg-gradient-to-br from-green-500 via-cyan-500 to-teal-500 p-1">
                ...
                <div className="relative w-full h-full rounded-full bg-slate-900 overflow-hidden z-10">
                  ...
                  />
                  <div className="w-full h-full flex items-center justify-center text-5xl md:text-8xl font-black text-white" style={{ display: 'none' }}>
                    DL
                  </div>
                </div>
              </div>
          ...
          <div ref={contentRef} className="flex-1 text-left lg:text-center">
            <div className="bg-slate-800/60 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-slate-700/50 shadow-2xl">
              <h3 className="text-2xl md:text-4xl font-bold text-white mb-4 bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent">
                Daniel W Liu
              </h3>
              ...
              <div className="mb-6 md:mb-8">
                <h4 className="text-white font-semibold mb-3 md:mb-4 text-sm md:text-base">Tech Stack</h4>
